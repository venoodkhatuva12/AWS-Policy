...
def merge_json(input_files, output_file = "output.json"): #removing old output file
if os.path.isfile(output_file):
    os.remove(output_file)# read json file from current dir
output = []
policy_number = 0
output = {
    "Version": "2012-10-17",
...
for file in input_files:
    file = file + ".json"
if os.path.isfile(file): #Read file content
...
print output# Write file content
